...
namespace MVCT.Controllers
{
    ...
    public class RoleController : Controller
    {
        ...
        public RoleController(ILogger<RoleController> logger, RoleManager<IdentityRole> roleManager, ApplicationDbContext context, UserManager<AppUser> userManager)
        {
            _logger = logger;
